...
from app.schemas.video import (
    TrendingVideo, Snapshot, PaginatedTrendingResponse, DashboardResponse
)
...
@router.get("/trending", response_model=PaginatedTrendingResponse)
...
@router.get("/{video_id}/trajectory", response_model=List[Snapshot])
